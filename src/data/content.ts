...
export const projects = [
  { title: "Carga general", text: "Carrocería para operación de carga", src: "/images/pending/camion-carga-general-cral.jpeg", alt: "Camión amarillo con carrocería de carga general", width: 1200, height: 1600 },
  { title: "Montaje de frío", text: "Instalación de equipo de refrigeración", src: "/images/pending/montaje-equipo-frio.jpeg", alt: "Instalación de equipo de frío sobre carrocería", width: 1600, height: 900 },
  { title: "Furgón de carga", text: "Solución cerrada para distribución", src: "/images/pending/furgon-aluminio-carga.jpeg", alt: "Camión con furgón metálico de carga", width: 1600, height: 900 },
  { title: "Terminaciones", text: "Detalle de carrocería y estructura", src: "/images/pending/detalle-carroceria-plataforma.jpeg", alt: "Detalle lateral de carrocería blanca", width: 1600, height: 1200 },
  { title: "Carrocería con persianas", text: "Configuración para carga y descarga", src: "/images/pending/carroceria-persianas-amarilla.jpeg", alt: "Camión con carrocería amarilla y persianas metálicas", width: 1600, height: 1200 },
  { title: "Carrocería sider", text: "Solución lateral para transporte", src: "/images/pending/carroceria-sider-negra.jpeg", alt: "Camión con carrocería sider negra", width: 1600, height: 900 },
  { title: "Furgón de distribución", text: "Carrocería cerrada para reparto", src: "/images/pending/furgon-distribucion-blanco.jpeg", alt: "Camión liviano con furgón blanco", width: 1200, height: 1200 }
];
export const faqs = [
